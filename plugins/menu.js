...
templateButtons: [{urlButton: {displayText: 'Github', url: 'https://github.com/umar404/umar-bug-md'}},{urlButton: {displayText: 'Contact Owner', url: `https://wa.me/${BOT_INFO.split(";")[2]}`}},{quickReplyButton: {displayText: 'Speed Test', id: prefix + 'ping'}},{quickReplyButton: {displayText: 'List Commands', id: prefix + 'list'}}]
})
});
